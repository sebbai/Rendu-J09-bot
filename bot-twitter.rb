...
require 'dotenv' #<= Pour appeler et charger(ligne du bas) le fichier.env avec les clés API.
Dotenv.load
...
=begin
topics = ["coffee", "tea", "THP", "TheHackingProject"]
